  ...
  return (
    <div className="max-w-screen-xl mx-auto px-4 lg:px-6 py-10">
      ...
      <div className="mb-10">
        ...
        <h1 className="font-display font-black text-4xl lg:text-5xl text-gray-900 dark:text-white">Trending & Viral</h1>
        ...
        <div className="space-y-3">
          {trendingPosts.map((post, i) => (
            <Link key={post.id} to={`/article/${post.slug}`}
              ...
              <div className="img-zoom w-20 h-16 rounded-xl overflow-hidden flex-shrink-0">
