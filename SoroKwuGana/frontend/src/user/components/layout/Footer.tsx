...
function NewsletterForm() {
  ...
  if (status === 'success') {
    return (
      <div className="flex items-center gap-3 bg-emerald-500/15 border border-emerald-500/30 rounded-xl px-5 py-3.5 w-full lg:w-auto">
  ...
  return (
    <div className="w-full lg:w-auto">
      <form className="flex gap-2 w-full lg:w-auto" onSubmit={handleSubmit}>
        <input
          type="email"
          value={email}
        ...
        <button
          ...
          className="bg-gradient-to-r from-[#6C63FF] to-[#FF4D6D] text-white font-bold px-6 py-3 rounded-xl text-sm hover:opacity-90 disabled:opacity-60 transition-opacity whitespace-nowrap shadow-lg flex items-center gap-2"
        >
          {status === 'loading'
      ...
      {status === 'error' && (
        <p className="mt-2 text-xs text-red-400 font-medium">{message}</p>
      )}
    </div>
  );
}
...
export default function Footer() {
  return (
    <footer className="bg-gray-950 text-gray-400">
      ...
      <div className="border-b border-gray-800">
        <div className="max-w-screen-xl mx-auto px-4 lg:px-6 py-10 flex flex-col lg:flex-row items-center justify-between gap-6">
          <div className="text-center lg:text-left">
            <h3 className="font-display font-black text-xl sm:text-2xl text-white mb-1">Never miss a story.</h3>
      ...
      {/* Main footer grid */}
      <div className="max-w-screen-xl mx-auto px-4 lg:px-6 py-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 text-center sm:text-left">
        {/* Brand */}
      ...
      <div className="border-t border-gray-800">
        <div className="max-w-screen-xl mx-auto px-4 lg:px-6 py-5 flex flex-col sm:flex-row items-center justify-between gap-2 text-xs text-center sm:text-left">
